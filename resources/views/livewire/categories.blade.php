                      ...
                      <div class="card-header">
                        <ul class="nav nav-pills card-header-pills">
                          ...
                          <li class="nav-item ms-auto">
                            <a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#categories_modal">Add Category</a>
                        </li>
                        </ul>
                      </div>
                      <div class="card-body">
                    ...
                    <div class="card">
                      <div class="card-header">
                        <ul class="nav nav-pills card-header-pills">
                            <h4>SubCategories</h4>
                          <li class="nav-item ms-auto">
                            <a href="{{route('author.subcategories')}}" class="btn btn-sm btn-primary">Add Sub Category</a>
                        </li>
                        </ul>
                      </div>
                      <div class="card-body">
